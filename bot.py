...
SHOP_ITEMS = {
    "extra5": {"name": "+5 запросов", "price": 10, "icon": "📝", "category": "text", "desc": "Добавляет 5 текстовых запросов к дневному лимиту.", "warning": "⚠️ Доп запросы сгорают в 00:00 МСК.", "usage": "Используйте в ЛС с ботом."},
    "extra10": {"name": "+10 запросов", "price": 18, "icon": "📝", "category": "text", "desc": "Добавляет 10 текстовых запросов к дневному лимиту.", "warning": "⚠️ Доп запросы сгорают в 00:00 МСК.", "usage": "Используйте в ЛС с ботом."},
    "extra50": {"name": "+50 запросов", "price": 80, "icon": "📝", "category": "text", "desc": "Добавляет 50 текстовых запросов. Экономия 20 токенов!", "warning": "⚠️ Доп запросы сгорают в 00:00 МСК.", "usage": "Используйте в ЛС с ботом."},
    "unlimited_1h": {"name": "Безлимит текст 1 час", "price": 30, "icon": "♾️", "category": "text", "desc": "Неограниченные текстовые запросы на 1 час.", "warning": "⚠️ Действует ровно 1 час.", "usage": "Все текстовые запросы не учитываются в лимите."},
    "unlimited_24h": {"name": "Безлимит текст 24 часа", "price": 100, "icon": "♾️", "category": "text", "desc": "Неограниченные текстовые запросы на 24 часа.", "warning": "⚠️ Действует ровно 24 часа.", "usage": "Все текстовые запросы не учитываются в лимите."},
    "unlimited_7d": {"name": "Безлимит текст 7 дней", "price": 500, "icon": "♾️", "category": "text", "desc": "Неограниченные текстовые запросы на 7 дней.", "warning": "⚠️ Действует ровно 7 дней.", "usage": "Все текстовые запросы не учитываются в лимите."},
    "image1": {"name": "1 генерация фото", "price": 15, "icon": "🎨", "category": "image", "desc": "Добавляет 1 генерацию изображения.", "warning": "⚠️ Генерации сгорают в 00:00 МСК.", "usage": "Опишите что нарисовать — бот создаст изображение."},
    "image5": {"name": "5 генераций фото", "price": 60, "icon": "🎨", "category": "image", "desc": "Добавляет 5 генераций изображений.", "warning": "⚠️ Генерации сгорают в 00:00 МСК.", "usage": "Опишите что нарисовать — бот создаст изображение."},
    "image20": {"name": "20 генераций фото", "price": 200, "icon": "🎨", "category": "image", "desc": "Добавляет 20 генераций. Экономия 100 токенов!", "warning": "⚠️ Генерации сгорают в 00:00 МСК.", "usage": "Опишите что нарисовать — бот создаст изображение."},
    "image_unlimited_1h": {"name": "Безлимит фото 1 час", "price": 50, "icon": "♾️", "category": "image", "desc": "Неограниченная генерация фото на 1 час.", "warning": "⚠️ Действует ровно 1 час.", "usage": "Все генерации фото не учитываются в лимите."},
    "premium_day": {"name": "Премиум ЛС 1 день", "price": 200, "icon": "⭐", "category": "premium", "desc": "Безлимит текста и фото в ЛС на 24 часа.", "warning": "⚠️ Действует ровно 24 часа.", "usage": "Отключает все лимиты в ЛС."},
    "premium_week": {"name": "Премиум ЛС 7 дней", "price": 1000, "icon": "⭐", "category": "premium", "desc": "Безлимит текста и фото в ЛС на 7 дней.", "warning": "⚠️ Действует ровно 7 дней.", "usage": "Отключает все лимиты в ЛС."},
    "premium_forever": {"name": "Премиум ЛС навсегда", "price": 2500, "icon": "👑", "category": "premium", "desc": "Навсегда отключает все лимиты в ЛС.", "warning": "⚠️ Только для ЛС. Не требует продления.", "usage": "Текст и фото в ЛС без ограничений навсегда."},
    "chat_extra10": {"name": "+10 запросов в чатах", "price": 15, "icon": "👥", "category": "chat", "desc": "Добавляет 10 запросов для всех участников чата.", "warning": "⚠️ Запросы сгорают в 00:00 МСК. Покупает владелец.", "usage": "Все участники получают +10 запросов."},
    "chat_extra50": {"name": "+50 запросов в чатах", "price": 60, "icon": "👥", "category": "chat", "desc": "Добавляет 50 запросов для всех. Экономия 15 токенов!", "warning": "⚠️ Запросы сгорают в 00:00 МСК. Покупает владелец.", "usage": "Все участники получают +50 запросов."},
    "chat_unlimited_1h": {"name": "Безлимит чат 1 час", "price": 40, "icon": "♾️", "category": "chat", "desc": "Неограниченные запросы для всех на 1 час.", "warning": "⚠️ Действует ровно 1 час. Покупает владелец.", "usage": "Все участники могут задавать вопросы без ограничений."},
    "chat_unlimited_24h": {"name": "Безлимит чат 24 часа", "price": 150, "icon": "♾️", "category": "chat", "desc": "Неограниченные запросы для всех на 24 часа.", "warning": "⚠️ Действует ровно 24 часа. Покупает владелец.", "usage": "Все участники могут задавать вопросы без ограничений."},
    "chat_image5": {"name": "5 фото в чатах", "price": 50, "icon": "🖼️", "category": "chat_image", "desc": "Добавляет 5 генераций фото для всех участников.", "warning": "⚠️ Генерации сгорают в 00:00 МСК. Покупает владелец.", "usage": "Все участники получают +5 генераций фото."},
    "chat_image20": {"name": "20 фото в чатах", "price": 180, "icon": "🖼️", "category": "chat_image", "desc": "Добавляет 20 генераций фото для всех. Экономия 20 токенов!", "warning": "⚠️ Генерации сгорают в 00:00 МСК. Покупает владелец.", "usage": "Все участники получают +20 генераций фото."},
    "chat_premium_day": {"name": "Премиум чат 1 день", "price": 300, "icon": "⭐", "category": "chat_premium", "desc": "Безлимит текста и фото для всех на 24 часа.", "warning": "⚠️ Действует ровно 24 часа. Покупает владелец.", "usage": "Все участники получают безлимит текста и фото."},
    "chat_premium_week": {"name": "Премиум чат 7 дней", "price": 1500, "icon": "⭐", "category": "chat_premium", "desc": "Безлимит текста и фото для всех на 7 дней.", "warning": "⚠️ Действует ровно 7 дней. Покупает владелец.", "usage": "Все участники получают безлимит текста и фото."},
    "chat_premium_forever": {"name": "Премиум чат навсегда", "price": 3500, "icon": "👑", "category": "chat_premium", "desc": "Навсегда отключает лимиты для всех участников чата.", "warning": "⚠️ Покупает владелец. Не требует продления.", "usage": "Все участники навсегда получают безлимит."},
}
...
Да. Все доп запросы и генерации сгорают в 00:00 МСК. Покупайте только то, что планируете использовать сегодня.

❓ Что даёт Премиум?
Полностью отключает все лимиты на выбранный срок или навсегда.

❓ Чем отличается Премиум ЛС от Премиум Чата?
Премиум ЛС — безлимит только для вас.
...
Нет. Безлимиты действуют ровно указанное время (1ч, 24ч, 7д, навсегда).

❓ Можно ли вернуть токены?
...
async def inline_button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "none": return
    if data == "menu": await query.edit_message_text(f"🧠 NeBlock AI V2\n💰 {get_tokens(user_id)} токенов", reply_markup=main_menu())
    elif data == "about": await query.edit_message_text("ℹ️ NeBlock AI V2\n\n💬 Текст\n🎨 Фото\n👥 Чаты\n💎 Премиум", reply_markup=back_button())
    elif data == "models": await query.edit_message_text(MODELS_INFO, reply_markup=back_button())
    elif data == "premium_info":
        await query.edit_message_text("💎 Премиум\n━━━━━━━━━━━━━━━━\n\nПремиум ЛС:\n• 1 день — 200\n• 7 дней — 1000\n• Навсегда — 2500\n\nПремиум Чат:\n• 1 день — 300\n• 7 дней — 1500\n• Навсегда — 3500", reply_markup=back_button())
    elif data == "stats":
        user = get_user(user_id)
        ...
        if tokens < item["price"]: await query.answer(f"❌ Недостаточно!", show_alert=True); return
        remove_tokens(user_id, item["price"]); users = load_users(); uid = str(user_id)
        actions = {
        ...
        if item_id in actions: field, amount = actions[item_id]; users[uid][field] = users[uid].get(field, 0) + amount
            ...
            for cid, cdata in chats.items():
                if isinstance(cdata, dict) and str(user_id) in cdata.get("owners", []):
                    chats[cid]["premium_until"] = (datetime.now() + timedelta(hours=hours_map[item_id])).isoformat(); save_chats(chats); break
        save_users(users)
        ...
        if not item: return
        tokens = get_tokens(user_id); can = "✅ Хватает" if tokens >= item["price"] else "❌ Не хватает"
...
async def message_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if context.user_data.get("waiting_promo"):
        context.user_data["waiting_promo"] = False; success, result = use_promo(user_id, text)
    ...
    if is_image_request or user.get("current_model") == "image" or user.get("waiting_for_image"):
        ...
        if not can_image_request(user_id, chat_type, chat_id):
            ...
            await update.message.reply_text(f"🚫 Лимит фото!\n📊 Осталось: {rem}", reply_to_message_id=update.message.message_id if chat_type != "private" else None, reply_markup=limit_reached_keyboard() if chat_type == "private" else None)
            return
        ...
        try:
            ...
            if image_bytes:
                add_image_request(user_id, chat_type); await msg.delete(); rem = image_remaining(user_id, chat_type, chat_id)
    ...
    if not can_request(user_id, chat_type, chat_id):
        ...
        await update.message.reply_text(f"🚫 Лимит!\n📊 Осталось: {rem}", reply_markup=limit_reached_keyboard() if chat_type == "private" else None, reply_to_message_id=update.message.message_id if chat_type != "private" else None)
        return
